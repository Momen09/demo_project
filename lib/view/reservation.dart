...
class _ReservationScreenState extends State<ReservationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const IconData horizontalRuleRounded =
          ...
          return ListView(
            children: [
              ...
              Padding(
                ...
                child: Container(
                  color:isDark?Colors.grey.shade200:Theme.of(context).scaffoldBackgroundColor,
                  child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          addressContainer(provider, size),
                          SizedBox(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              _textWidget(
                                provider.reservations.first.stays!.first.amenities,
                                Colors.grey.shade600,
                                15,
                                true,
                              ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              provider.openGoogleMapsForFirstStay(context);
            },
            child: Image.asset(
  ...
  Container ticket2(Size size) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _textWidget('Ticket Type :',isDark ? Colors.black : Colors.white, 18, true),
          SizedBox(
            height: size.height * 0.01,
          ),
